 ...
 * This file demonstrates how to integrate Yarnbeacon with a web frontend
 */

// For React/Vue/Angular applications
export class YarnbeaconClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new YarnbeaconClient(provider, contractAddress);
